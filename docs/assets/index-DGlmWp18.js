...
}`;function gm(a,t,e){let i=new cs;const n=new yt,s=new yt,r=new ge,o=new Uc({depthPacking:kh}),l=new Fc,h={},c=e.maxTextureSize,d={[Zi]:ke,[ke]:Zi,[Ze]:Ze},u=new bi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new yt},radius:{value:4}},vertexShader:pm,fragmentShader:mm}),f=u.clone();f.defines.HORIZONTAL_PASS=1;const m=new ze;m.setAttribute("position",new He(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Qt(m,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=wl;let p=this.type;this.render=function(M,A,R){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||M.length===0)return;const T=a.getRenderTarget(),y=a.getActiveCubeFace(),C=a.getActiveMipmapLevel(),P=a.state;P.setBlending(Ii),P.buffers.depth.getReversed()===!0?P.buffers.color.setClear(0,0,0,0):P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);const F=p!==Ci&&this.type===Ci,O=p===Ci&&this.type!==Ci;for(let H=0,V=M.length;H<V;H++){const Q=M[H],W=Q.shadow;if(W===void 0){Lt("WebGLShadowMap:",Q,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;n.copy(W.mapSize);const tt=W.getFrameExtents();if(n.multiply(tt),s.copy(W.mapSize),(n.x>c||n.y>c)&&(n.x>c&&(s.x=Math.floor(c/tt.x),n.x=s.x*tt.x,W.mapSize.x=s.x),n.y>c&&(s.y=Math.floor(c/tt.y),n.y=s.y*tt.y,W.mapSize.y=s.y)),W.map===null||F===!0||O===!0){const bt=this.type!==Ci?{minFilter:Ye,magFilter:Ye}:{};W.map!==null&&W.map.dispose(),W.map=new hn(n.x,n.y,bt),W.map.texture.name=Q.name+".shadowMap",W.camera.updateProjectionMatrix()}a.setRenderTarget(W.map),a.clear();const it=W.getViewportCount();for(let bt=0;bt<it;bt++){const Vt=W.getViewport(bt);r.set(s.x*Vt.x,s.y*Vt.y,s.x*Vt.z,s.y*Vt.w),P.viewport(r),W.updateMatrices(Q,bt),i=W.getFrustum(),v(A,R,W.camera,Q,this.type)}W.isPointLightShadow!==!0&&this.type===Ci&&b(W,R),W.needsUpdate=!1}p=this.type,g.needsUpdate=!1,a.setRenderTarget(T,y,C)};function b(M,A){const R=t.update(x);u.defines.VSM_SAMPLES!==M.blurSamples&&(u.defines.VSM_SAMPLES=M.blurSamples,f.defines.VSM_SAMPLES=M.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),M.mapPass===null&&(M.mapPass=new hn(n.x,n.y)),u.uniforms.shadow_pass.value=M.map.texture,u.uniforms.resolution.value=M.mapSize,u.uniforms.radius.value=M.radius,a.setRenderTarget(M.mapPass),a.clear(),a.renderBufferDirect(A,null,R,u,x,null),f.uniforms.shadow_pass.value=M.mapPass.texture,f.uniforms.resolution.value=M.mapSize,f.uniforms.radius.value=M.radius,a.setRenderTarget(M.map),a.clear(),a.renderBufferDirect(A,null,R,f,x,null)}function _(M,A,R,T){let y=null;const C=R.isPointLight===!0?M.customDistanceMaterial:M.customDepthMaterial;if(C!==void 0)y=C;else if(y=R.isPointLight===!0?l:o,a.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const P=y.uuid,F=A.uuid;let O=h[P];O===void 0&&(O={},h[P]=O);let H=O[F];H===void 0&&(H=y.clone(),O[F]=H,A.addEventListener("dispose",w)),y=H}if(y.visible=A.visible,y.wireframe=A.wireframe,T===Ci?y.side=A.shadowSide!==null?A.shadowSide:A.side:y.side=A.shadowSide!==null?A.shadowSide:d[A.side],y.alphaMap=A.alphaMap,y.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,y.map=A.map,y.clipShadows=A.clipShadows,y.clippingPlanes=A.clippingPlanes,y.clipIntersection=A.clipIntersection,y.displacementMap=A.displacementMap,y.displacementScale=A.displacementScale,y.displacementBias=A.displacementBias,y.wireframeLinewidth=A.wireframeLinewidth,y.linewidth=A.linewidth,R.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const P=a.properties.get(y);P.light=R}return y}function v(M,A,R,T,y){if(M.visible===!1)return;if(M.layers.test(A.layers)&&(M.isMesh||M.isLine||M.isPoints)&&(M.castShadow||M.receiveShadow&&y===Ci)&&(!M.frustumCulled||i.intersectsObject(M))){M.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,M.matrixWorld);const F=t.update(M),O=M.material;if(Array.isArray(O)){const H=F.groups;for(let V=0,Q=H.length;V<Q;V++){const W=H[V],tt=O[W.materialIndex];if(tt&&tt.visible){const it=_(M,tt,T,y);M.onBeforeShadow(a,M,A,R,F,it,W),a.renderBufferDirect(R,null,F,it,M,W),M.onAfterShadow(a,M,A,R,F,it,W)}}}else if(O.visible){const H=_(M,O,T,y);M.onBeforeShadow(a,M,A,R,F,H,null),a.renderBufferDirect(R,null,F,H,M,null),M.onAfterShadow(a,M,A,R,F,H,null)}}const P=M.children;for(let F=0,O=P.length;F<O;F++)v(P[F],A,R,T,y)}function w(M){M.target.removeEventListener("dispose",w);for(const R in h){const T=h[R],y=M.target.uuid;y in T&&(T[y].dispose(),delete T[y])}}}const xm={[Zr]:Yr,[jr]:Qr,[Kr]:ta,[Nn]:Jr,[Yr]:Zr,[Qr]:jr,[ta]:Kr,[Jr]:Nn};function _m(a,t){function e(){let L=!1;const ht=new ge;let st=null;const rt=new ge(0,0,0,0);return{setMask:function(J){st!==J&&!L&&(a.colorMask(J,J,J,J),st=J)},setLocked:function(J){L=J},setClear:function(J,Z,mt,Ft,oe){oe===!0&&(J*=Ft,Z*=Ft,mt*=Ft),ht.set(J,Z,mt,Ft),rt.equals(ht)===!1&&(a.clearColor(J,Z,mt,Ft),rt.copy(ht))},reset:function(){L=!1,st=null,rt.set(-1,0,0,0)}}}function i(){let L=!1,ht=!1,st=null,rt=null,J=null;return{setReversed:function(Z){if(ht!==Z){const mt=t.get("EXT_clip_control");Z?mt.clipControlEXT(mt.LOWER_LEFT_EXT,mt.ZERO_TO_ONE_EXT):mt.clipControlEXT(mt.LOWER_LEFT_EXT,mt.NEGATIVE_ONE_TO_ONE_EXT),ht=Z;const Ft=J;J=null,this.setClear(Ft)}},getReversed:function(){return ht},setTest:function(Z){Z?Y(a.DEPTH_TEST):pt(a.DEPTH_TEST)},setMask:function(Z){st!==Z&&!L&&(a.depthMask(Z),st=Z)},setFunc:function(Z){if(ht&&(Z=xm[Z]),rt!==Z){switch(Z){case Zr:a.depthFunc(a.NEVER);break;case Yr:a.depthFunc(a.ALWAYS);break;case jr:a.depthFunc(a.LESS);break;case Nn:a.depthFunc(a.LEQUAL);break;case Kr:a.depthFunc(a.EQUAL);break;case Jr:a.depthFunc(a.GEQUAL);break;case Qr:a.depthFunc(a.GREATER);break;case ta:a.depthFunc(a.NOTEQUAL);break;default:a.depthFunc(a.LEQUAL)}rt=Z}},setLocked:function(Z){L=Z},setClear:function(Z){J!==Z&&(ht&&(Z=1-Z),a.clearDepth(Z),J=Z)},reset:function(){L=!1,st=null,rt=null,J=null,ht=!1}}}function n(){let L=!1,ht=null,st=null,rt=null,J=null,Z=null,mt=null,Ft=null,oe=null;return{setTest:function(te){L||(te?Y(a.STENCIL_TEST):pt(a.STENCIL_TEST))},setMask:function(te){ht!==te&&!L&&(a.stencilMask(te),ht=te)},setFunc:function(te,mi,si){(st!==te||rt!==mi||J!==si)&&(a.stencilFunc(te,mi,si),st=te,rt=mi,J=si)},setOp:function(te,mi,si){(Z!==te||mt!==mi||Ft!==si)&&(a.stencilOp(te,mi,si),Z=te,mt=mi,Ft=si)},setLocked:function(te){L=te},setClear:function(te){oe!==te&&(a.clearStencil(te),oe=te)},reset:function(){L=!1,ht=null,st=null,rt=null,J=null,Z=null,mt=null,Ft=null,oe=null}}}const s=new e,r=new i,o=new n,l=new WeakMap,h=new WeakMap;let c={},d={},u=new WeakMap,f=[],m=null,x=!1,g=null,p=null,b=null,_=null,v=null,w=null,M=null,A=new ut(0,0,0),R=0,T=!1,y=null,C=null,P=null,F=null,O=null;const H=a.getParameter(a.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,Q=0;const W=a.getParameter(a.VERSION);W.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(W)[1]),V=Q>=1):W.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),V=Q>=2);let tt=null,it={};const bt=a.getParameter(a.SCISSOR_BOX),Vt=a.getParameter(a.VIEWPORT),Gt=new ge().fromArray(bt),Zt=new ge().fromArray(Vt);function Wt(L,ht,st,rt){const J=new Uint8Array(4),Z=a.createTexture();a.bindTexture(L,Z),a.texParameteri(L,a.TEXTURE_MIN_FILTER,a.NEAREST),a.texParameteri(L,a.TEXTURE_MAG_FILTER,a.NEAREST);for(let mt=0;mt<st;mt++)L===a.TEXTURE_3D||L===a.TEXTURE_2D_ARRAY?a.texImage3D(ht,0,a.RGBA,1,1,rt,0,a.RGBA,a.UNSIGNED_BYTE,J):a.texImage2D(ht+mt,0,a.RGBA,1,1,0,a.RGBA,a.UNSIGNED_BYTE,J);return Z}const q={};q[a.TEXTURE_2D]=Wt(a.TEXTURE_2D,a.TEXTURE_2D,1),q[a.TEXTURE_CUBE_MAP]=Wt(a.TEXTURE_CUBE_MAP,a.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[a.TEXTURE_2D_ARRAY]=Wt(a.TEXTURE_2D_ARRAY,a.TEXTURE_2D_ARRAY,1,1),q[a.TEXTURE_3D]=Wt(a.TEXTURE_3D,a.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),Y(a.DEPTH_TEST),r.setFunc(Nn),Xt(!1),qt(ho),Y(a.CULL_FACE),he(Ii);function Y(L){c[L]!==!0&&(a.enable(L),c[L]=!0)}function pt(L){c[L]!==!1&&(a.disable(L),c[L]=!1)}function Ut(L,ht){return d[L]!==ht?(a.bindFramebuffer(L,ht),d[L]=ht,L===a.DRAW_FRAMEBUFFER&&(d[a.FRAMEBUFFER]=ht),L===a.FRAMEBUFFER&&(d[a.DRAW_FRAMEBUFFER]=ht),!0):!1}function _t(L,ht){let st=f,rt=!1;if(L){st=u.get(ht),st===void 0&&(st=[],u.set(ht,st));const J=L.textures;if(st.length!==J.length||st[0]!==a.COLOR_ATTACHMENT0){for(let Z=0,mt=J.length;Z<mt;Z++)st[Z]=a.COLOR_ATTACHMENT0+Z;st.length=J.length,rt=!0}}else st[0]!==a.BACK&&(st[0]=a.BACK,rt=!0);rt&&a.drawBuffers(st)}function Bt(L){return m!==L?(a.useProgram(L),m=L,!0):!1}const Te={[sn]:a.FUNC_ADD,[fh]:a.FUNC_SUBTRACT,[ph]:a.FUNC_REVERSE_SUBTRACT};Te[mh]=a.MIN,Te[gh]=a.MAX;const kt={[xh]:a.ZERO,[_h]:a.ONE,[Mh]:a.SRC_COLOR,[qr]:a.SRC_ALPHA,[Th]:a.SRC_ALPHA_SATURATE,[Sh]:a.DST_COLOR,[yh]:a.DST_ALPHA,[vh]:a.ONE_MINUS_SRC_COLOR,[$r]:a.ONE_MINUS_SRC_ALPHA,[wh]:a.ONE_MINUS_DST_COLOR,[bh]:a.ONE_MINUS_DST_ALPHA,[Eh]:a.CONSTANT_COLOR,[Ah]:a.ONE_MINUS_CONSTANT_COLOR,[Rh]:a.CONSTANT_ALPHA,[Ch]:a.ONE_MINUS_CONSTANT_ALPHA};function he(L,ht,st,rt,J,Z,mt,Ft,oe,te){if(L===Ii){x===!0&&(pt(a.BLEND),x=!1);return}if(x===!1&&(Y(a.BLEND),x=!0),L!==uh){if(L!==g||te!==T){if((p!==sn||v!==sn)&&(a.blendEquation(a.FUNC_ADD),p=sn,v=sn),te)switch(L){case an:a.blendFuncSeparate(a.ONE,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);break;case Xr:a.blendFunc(a.ONE,a.ONE);break;case co:a.blendFuncSeparate(a.ZERO,a.ONE_MINUS_SRC_COLOR,a.ZERO,a.ONE);break;case uo:a.blendFuncSeparate(a.DST_COLOR,a.ONE_MINUS_SRC_ALPHA,a.ZERO,a.ONE);break;default:fe("WebGLState: Invalid blending: ",L);break}else switch(L){case an:a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA);break;case Xr:a.blendFuncSeparate(a.SRC_ALPHA,a.ONE,a.ONE,a.ONE);break;case co:fe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case uo:fe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:fe("WebGLState: Invalid blending: ",L);break}b=null,_=null,w=null,M=null,A.set(0,0,0),R=0,g=L,T=te}return}J=J||ht,Z=Z||st,mt=mt||rt,(ht!==p||J!==v)&&(a.blendEquationSeparate(Te[ht],Te[J]),p=ht,v=J),(st!==b||rt!==_||Z!==w||mt!==M)&&(a.blendFuncSeparate(kt[st],kt[rt],kt[Z],kt[mt]),b=st,_=rt,w=Z,M=mt),(Ft.equals(A)===!1||oe!==R)&&(a.blendColor(Ft.r,Ft.g,Ft.b,oe),A.copy(Ft),R=oe),g=L,T=!1}function I(L,ht){L.side===Ze?pt(a.CULL_FACE):Y(a.CULL_FACE);let st=L.side===ke;ht&&(st=!st),Xt(st),L.blending===an&&L.transparent===!1?he(Ii):he(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),r.setFunc(L.depthFunc),r.setTest(L.depthTest),r.setMask(L.depthWrite),s.setMask(L.colorWrite);const rt=L.stencilWrite;o.setTest(rt),rt&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),xt(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?Y(a.SAMPLE_ALPHA_TO_COVERAGE):pt(a.SAMPLE_ALPHA_TO_COVERAGE)}function Xt(L){y!==L&&(L?a.frontFace(a.CW):a.frontFace(a.CCW),y=L)}function qt(L){L!==hh?(Y(a.CULL_FACE),L!==C&&(L===ho?a.cullFace(a.BACK):L===ch?a.cullFace(a.FRONT):a.cullFace(a.FRONT_AND_BACK))):pt(a.CULL_FACE),C=L}function ae(L){L!==P&&(V&&a.lineWidth(L),P=L)}function xt(L,ht,st){L?(Y(a.POLYGON_OFFSET_FILL),(F!==ht||O!==st)&&(a.polygonOffset(ht,st),F=ht,O=st)):pt(a.POLYGON_OFFSET_FILL)}function ce(L){L?Y(a.SCISSOR_TEST):pt(a.SCISSOR_TEST)}function wt(L){L===void 0&&(L=a.TEXTURE0+H-1),tt!==L&&(a.activeTexture(L),tt=L)}function Nt(L,ht,st){st===void 0&&(tt===null?st=a.TEXTURE0+H-1:st=tt);let rt=it[st];rt===void 0&&(rt={type:void 0,texture:void 0},it[st]=rt),(rt.type!==L||rt.texture!==ht)&&(tt!==st&&(a.activeTexture(st),tt=st),a.bindTexture(L,ht||q[L]),rt.type=L,rt.texture=ht)}function D(){const L=it[tt];L!==void 0&&L.type!==void 0&&(a.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function S(){try{a.compressedTexImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function B(){try{a.compressedTexImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function $(){try{a.texSubImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function j(){try{a.texSubImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function X(){try{a.compressedTexSubImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function vt(){try{a.compressedTexSubImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function lt(){try{a.texStorage2D(...arguments)}catch(L){L("WebGLState:",L)}}function Tt(){try{a.texStorage3D(...arguments)}catch(L){L("WebGLState:",L)}}function Mt(){try{a.texImage2D(...arguments)}catch(L){L("WebGLState:",L)}}function K(){try{a.texImage3D(...arguments)}catch(L){L("WebGLState:",L)}}function nt(L){Gt.equals(L)===!1&&(a.scissor(L.x,L.y,L.z,L.w),Gt.copy(L))}function Dt(L){Zt.equals(L)===!1&&(a.viewport(L.x,L.y,L.z,L.w),Zt.copy(L))}function Rt(L,ht){let st=h.get(ht);st===void 0&&(st=new WeakMap,h.set(ht,st));let rt=st.get(L);rt===void 0&&(rt=a.getUniformBlockIndex(ht,L.name),st.set(L,rt))}function dt(L,ht){const rt=h.get(ht).get(L);l.get(ht)!==rt&&(a.uniformBlockBinding(ht,rt,L.__bindingPointIndex),l.set(ht,rt))}function It(){a.disable(a.BLEND),a.disable(a.CULL_FACE),a.disable(a.DEPTH_TEST),a.disable(a.POLYGON_OFFSET_FILL),a.disable(a.SCISSOR_TEST),a.disable(a.STENCIL_TEST),a.disable(a.SAMPLE_ALPHA_TO_COVERAGE),a.blendEquation(a.FUNC_ADD),a.blendFunc(a.ONE,a.ZERO),a.blendFuncSeparate(a.ONE,a.ZERO,a.ONE,a.ZERO),a.blendColor(0,0,0,0),a.colorMask(!0,!0,!0,!0),a.clearColor(0,0,0,0),a.depthMask(!0),a.depthFunc(a.LESS),r.setReversed(!1),a.clearDepth(1),a.stencilMask(4294967295),a.stencilFunc(a.ALWAYS,0,4294967295),a.stencilOp(a.KEEP,a.KEEP,a.KEEP),a.clearStencil(0),a.cullFace(a.BACK),a.frontFace(a.CCW),a.polygonOffset(0,0),a.activeTexture(a.TEXTURE0),a.bindFramebuffer(a.FRAMEBUFFER,null),a.bindFramebuffer(a.DRAW_FRAMEBUFFER,null),a.bindFramebuffer(a.READ_FRAMEBUFFER,null),a.useProgram(null),a.lineWidth(1),a.scissor(0,0,a.canvas.width,a.canvas.height),a.viewport(0,0,a.canvas.width,a.canvas.height),c={},tt=null,it={},d={},u=new WeakMap,f=[],m=null,x=!1,g=null,p=null,b=null,_=null,v=null,w=null,M=null,A=new ut(0,0,0),R=0,T=!1,y=null,C=null,P=null,F=null,O=null,Gt.set(0,0,a.canvas.width,a.canvas.height),Zt.set(0,0,a.canvas.width,a.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:Y,disable:pt,bindFramebuffer:Ut,drawBuffers:_t,useProgram:Bt,setBlending:he,setMaterial:I,setFlipSided:Xt,setCullFace:qt,setLineWidth:ae,setPolygonOffset:xt,setScissorTest:ce,activeTexture:wt,bindTexture:Nt,unbindTexture:D,compressedTexImage2D:S,compressedTexImage3D:B,texImage2D:Mt,texImage3D:K,updateUBOMapping:Rt,uniformBlockBinding:dt,texStorage2D:lt,texStorage3D:Tt,texSubImage2D:$,texSubImage3D:j,compressedTexSubImage2D:X,compressedTexSubImage3D:vt,scissor:nt,viewport:Dt,reset:It}}function Mm(a,t,e,i,n,s,r){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new yt,c=new WeakMap;let d;const u=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function m(D,S){return f?new OffscreenCanvas(D,S):js("canvas")}function x(D,S,B){let $=1;const j=Nt(D);if((j.width>B||j.height>B)&&($=B/Math.max(j.width,j.height)),$<1)if(typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&D instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&D instanceof ImageBitmap||typeof VideoFrame<"u"&&D instanceof VideoFrame){const X=Math.floor($*j.width),vt=Math.floor($*j.height);d===void 0&&(d=m(X,vt));const lt=S?m(X,vt):d;return lt.width=X,lt.height=vt,lt.getContext("2d").drawImage(D,0,0,X,vt),Lt("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+X+"x"+vt+")."),lt}else return"data"in D&&Lt("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),D;return D}function g(D){return D.generateMipmaps}function p(D){a.generateMipmap(D)}function b(D){return D.isWebGLCubeRenderTarget?a.TEXTURE_CUBE_MAP:D.isWebGL3DRenderTarget?a.TEXTURE_3D:D.isWebGLArrayRenderTarget||D.isCompressedArrayTexture?a.TEXTURE_2D_ARRAY:a.TEXTURE_2D}function _(D,S,B,$,j=!1){if(D!==null){if(a[D]!==void 0)return a[D];Lt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+D+"'")}let X=S;if(S===a.RED&&(B===a.FLOAT&&(X=a.R32F),B===a.HALF_FLOAT&&(X=a.R16F),B===a.UNSIGNED_BYTE&&(X=a.R8)),S===a.RED_INTEGER&&(B===a.UNSIGNED_BYTE&&(X=a.R8UI),B===a.UNSIGNED_SHORT&&(X=a.R16UI),B===a.UNSIGNED_INT&&(X=a.R32UI),B===a.BYTE&&(X=a.R8I),B===a.SHORT&&(X=a.R16I),B===a.INT&&(X=a.R32I)),S===a.RG&&(B===a.FLOAT&&(X=a.RG32F),B===a.HALF_FLOAT&&(X=a.RG16F),B===a.UNSIGNED_BYTE&&(X=a.RG8)),S===a.RG_INTEGER&&(B===a.UNSIGNED_BYTE&&(X=a.RG8UI),B===a.UNSIGNED_SHORT&&(X=a.RG16UI),B===a.UNSIGNED_INT&&(X=a.RG32UI),B===a.BYTE&&(X=a.RG8I),B===a.SHORT&&(X=a.RG16I),B===a.INT&&(X=a.RG32I)),S===a.RGB_INTEGER&&(B===a.UNSIGNED_BYTE&&(X=a.RGB8UI),B===a.UNSIGNED_SHORT&&(X=a.RGB16UI),B===a.UNSIGNED_INT&&(X=a.RGB32UI),B===a.BYTE&&(X=a.RGB8I),B===a.SHORT&&(X=a.RGB16I),B===a.INT&&(X=a.RGB32I)),S===a.RGBA_INTEGER&&(B===a.UNSIGNED_BYTE&&(X=a.RGBA8UI),B===a.UNSIGNED_SHORT&&(X=a.RGBA16UI),B===a.UNSIGNED_INT&&(X=a.RGBA32UI),B===a.BYTE&&(X=a.RGBA8I),B===a.SHORT&&(X=a.RGBA16I),B===a.INT&&(X=a.RGBA32I)),S===a.RGB&&(B===a.UNSIGNED_INT_5_9_9_9_REV&&(X=a.RGB9_E5),B===a.UNSIGNED_INT_10F_11F_11F_REV&&(X=a.R11F_G11F_B10F)),S===a.RGBA){const vt=j?Zs:jt.getTransfer($);B===a.FLOAT&&(X=a.RGBA32F),B===a.HALF_FLOAT&&(X=a.RGBA16F),B===a.UNSIGNED_BYTE&&(X=vt===ie?a.SRGB8_ALPHA8:a.RGBA8),B===a.UNSIGNED_SHORT_4_4_4_4&&(X=a.RGBA4),B===a.UNSIGNED_SHORT_5_5_5_1&&(X=a.RGB5_A1)}return(X===a.R16F||X===a.R32F||X===a.RG16F||X===a.RG32F||X===a.RGBA16F||X===a.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function v(D,S){let B;return D?S===null||S===on||S===rs?B=a.DEPTH24_STENCIL8:S===Mi?B=a.DEPTH32F_STENCIL8:S===ss&&(B=a.DEPTH24_STENCIL8,Lt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===on||S===rs?B=a.DEPTH_COMPONENT24:S===Mi?B=a.DEPTH_COMPONENT32F:S===ss&&(B=a.DEPTH_COMPONENT16),B}function w(D,S){return g(D)===!0||D.isFramebufferTexture&&D.minFilter!==Ye&&D.minFilter!==ti?Math.log2(Math.max(S.width,S.height))+1:D.mipmaps!==void 0&&D.mipmaps.length>0?D.mipmaps.length:D.isCompressedTexture&&Array.isArray(D.image)?S.mipmaps.length:1}function M(D){const S=D.target;S.removeEventListener("dispose",M),R(S),S.isVideoTexture&&c.delete(S)}function A(D){const S=D.target;S.removeEventListener("dispose",A),y(S)}function R(D){const S=i.get(D);if(S.__webglInit===void 0)return;const B=D.source,$=u.get(B);if($){const j=$[S.__cacheKey];j.usedTimes--,j.usedTimes===0&&T(D),Object.keys($).length===0&&u.delete(B)}i.remove(D)}function T(D){const S=i.get(D);a.deleteTexture(S.__webglTexture);const B=D.source,$=u.get(B);delete $[S.__cacheKey],r.memory.textures--}function y(D){const S=i.get(D);if(D.depthTexture&&(D.depthTexture.dispose(),i.remove(D.depthTexture)),D.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(S.__webglFramebuffer[$]))for(let j=0;j<S.__webglFramebuffer[$].length;j++)a.deleteFramebuffer(S.__webglFramebuffer[$][j]);else a.deleteFramebuffer(S.__webglFramebuffer[$]);S.__webglDepthbuffer&&a.deleteRenderbuffer(S.__webglDepthbuffer[$])}else{if(Array.isArray(S.__webglFramebuffer))for(let $=0;$<S.__webglFramebuffer.length;$++)a.deleteFramebuffer(S.__webglFramebuffer[$]);else a.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&a.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&a.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let $=0;$<S.__webglColorRenderbuffer.length;$++)S.__webglColorRenderbuffer[$]&&a.deleteRenderbuffer(S.__webglColorRenderbuffer[$]);S.__webglDepthRenderbuffer&&a.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const B=D.textures;for(let $=0,j=B.length;$<j;$++){const X=i.get(B[$]);X.__webglTexture&&(a.deleteTexture(X.__webglTexture),r.memory.textures--),i.remove(B[$])}i.remove(D)}let C=0;function P(){C=0}function F(){const D=C;return D>=n.maxTextures&&Lt("WebGLTextures: Trying to use "+D+" texture units while this GPU supports only "+n.maxTextures),C+=1,D}function O(D){const S=[];return S.push(D.wrapS),S.push(D.wrapT),S.push(D.wrapR||0),S.push(D.magFilter),S.push(D.minFilter),S.push(D.anisotropy),S.push(D.internalFormat),S.push(D.format),S.push(D.type),S.push(D.generateMipmaps),S.push(D.premultiplyAlpha),S.push(D.flipY),S.push(D.unpackAlignment),S.push(D.colorSpace),S.join()}function H(D,S){const B=i.get(D);if(D.isVideoTexture&&ce(D),D.isRenderTargetTexture===!1&&D.isExternalTexture!==!0&&D.version>0&&B.__version!==D.version){const $=D.image;if($===null)Lt("WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)Lt("WebGLRenderer: Texture marked for update but image is incomplete");else{q(B,D,S);return}}else D.isExternalTexture&&(B.__webglTexture=D.sourceTexture?D.sourceTexture:null);e.bindTexture(a.TEXTURE_2D,B.__webglTexture,a.TEXTURE0+S)}function V(D,S){const B=i.get(D);if(D.isRenderTargetTexture===!1&&D.version>0&&B.__version!==D.version){q(B,D,S);return}else D.isExternalTexture&&(B.__webglTexture=D.sourceTexture?D.sourceTexture:null);e.bindTexture(a.TEXTURE_2D_ARRAY,B.__webglTexture,a.TEXTURE0+S)}function Q(D,S){const B=i.get(D);if(D.isRenderTargetTexture===!1&&D.version>0&&B.__version!==D.version){q(B,D,S);return}e.bindTexture(a.TEXTURE_3D,B.__webglTexture,a.TEXTURE0+S)}function W(D,S){const B=i.get(D);if(D.version>0&&B.__version!==D.version){Y(B,D,S);return}e.bindTexture(a.TEXTURE_CUBE_MAP,B.__webglTexture,a.TEXTURE0+S)}const tt={[na]:a.REPEAT,[Di]:a.CLAMP_TO_EDGE,[sa]:a.MIRRORED_REPEAT},it={[Ye]:a.NEAREST,[Oh]:a.NEAREST_MIPMAP_NEAREST,[fs]:a.NEAREST_MIPMAP_LINEAR,[ti]:a.LINEAR,[cr]:a.LINEAR_MIPMAP_NEAREST,[Wi]:a.LINEAR_MIPMAP_LINEAR},bt={[Vh]:a.NEVER,[Yh]:a.ALWAYS,[Wh]:a.LESS,[Il]:a.LEQUAL,[Xh]:a.EQUAL,[Zh]:a.GEQUAL,[qh]:a.GREATER,[$h]:a.NOTEQUAL};function Vt(D,S){if(S.type===Mi&&t.has("OES_texture_float_linear")===!1&&(S.magFilter===ti||S.magFilter===cr||S.magFilter===fs||S.magFilter===Wi||S.minFilter===ti||S.minFilter===cr||S.minFilter===fs||S.minFilter===Wi)&&Lt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),a.texParameteri(D,a.TEXTURE_WRAP_S,tt[S.wrapS]),a.texParameteri(D,a.TEXTURE_WRAP_T,tt[S.wrapT]),(D===a.TEXTURE_3D||D===a.TEXTURE_2D_ARRAY)&&a.texParameteri(D,a.TEXTURE_WRAP_R,tt[S.wrapR]),a.texParameteri(D,a.TEXTURE_MAG_FILTER,it[S.magFilter]),a.texParameteri(D,a.TEXTURE_MIN_FILTER,it[S.minFilter]),S.compareFunction&&(a.texParameteri(D,a.TEXTURE_COMPARE_MODE,a.COMPARE_REF_TO_TEXTURE),a.texParameteri(D,a.TEXTURE_COMPARE_FUNC,bt[S.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Ye||S.minFilter!==fs&&S.minFilter!==Wi||S.type===Mi&&t.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const B=t.get("EXT_texture_filter_anisotropic");a.texParameterf(D,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,n.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function Gt(D,S){let B=!1;D.__webglInit===void 0&&(D.__webglInit=!0,S.addEventListener("dispose",M));const $=S.source;let j=u.get($);j===void 0&&(j={},u.set($,j));const X=O(S);if(X!==D.__cacheKey){j[X]===void 0&&(j[X]={texture:a.createTexture(),usedTimes:0},r.memory.textures++,B=!0),j[X].usedTimes++;const vt=j[D.__cacheKey];vt!==void 0&&(j[D.__cacheKey].usedTimes--,vt.usedTimes===0&&T(S)),D.__cacheKey=X,D.__webglTexture=j[X].texture}return B}function Zt(D,S,B){return Math.floor(Math.floor(D/B)/S)}function Wt(D,S,B,$){const X=D.updateRanges;if(X.length===0)e.texSubImage2D(a.TEXTURE_2D,0,0,0,S.width,S.height,B,$,S.data);else{X.sort((K,nt)=>K.start-nt.start);let vt=0;for(let K=1;K<X.length;K++){const nt=X[vt],Dt=X[K],Rt=nt.start+nt.count,dt=Zt(Dt.start,S.width,4),It=Zt(nt.start,S.width,4);Dt.start<=Rt+1&&dt===It&&Zt(Dt.start+Dt.count-1,S.width,4)===dt?nt.count=Math.max(nt.count,Dt.start+Dt.count-nt.start):(++vt,X[vt]=Dt)}X.length=vt+1;const lt=a.getParameter(a.UNPACK_ROW_LENGTH),Tt=a.getParameter(a.UNPACK_SKIP_PIXELS),Mt=a.getParameter(a.UNPACK_SKIP_ROWS);a.pixelStorei(a.UNPACK_ROW_LENGTH,S.width);for(let K=0,nt=X.length;K<nt;K++){const Dt=X[K],Rt=Math.floor(Dt.start/4),dt=Math.ceil(Dt.count/4),It=Rt%S.width,L=Math.floor(Rt/S.width),ht=dt,st=1;a.pixelStorei(a.UNPACK_SKIP_PIXELS,It),a.pixelStorei(a.UNPACK_SKIP_ROWS,L),e.texSubImage2D(a.TEXTURE_2D,0,It,L,ht,st,B,$,S.data)}D.clearUpdateRanges(),a.pixelStorei(a.UNPACK_ROW_LENGTH,lt),a.pixelStorei(a.UNPACK_SKIP_PIXELS,Tt),a.pixelStorei(a.UNPACK_SKIP_ROWS,Mt)}}function q(D,S,B){let $=a.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&($=a.TEXTURE_2D_ARRAY),S.isData3DTexture&&($=a.TEXTURE_3D);const j=Gt(D,S),X=S.source;e.bindTexture($,D.__webglTexture,a.TEXTURE0+B);const vt=i.get(X);if(X.version!==vt.__version||j===!0){e.activeTexture(a.TEXTURE0+B);const lt=jt.getPrimaries(jt.workingColorSpace),Tt=S.colorSpace===Vi?null:jt.getPrimaries(S.colorSpace),Mt=S.colorSpace===Vi||lt===Tt?a.NONE:a.BROWSER_DEFAULT_WEBGL;a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,S.flipY),a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),a.pixelStorei(a.UNPACK_ALIGNMENT,S.unpackAlignment),a.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,Mt);let K=x(S.image,!1,n.maxTextureSize);K=wt(S,K);const nt=s.convert(S.format,S.colorSpace),Dt=s.convert(S.type);let Rt=_(S.internalFormat,nt,Dt,S.colorSpace,S.isVideoTexture);Vt($,S);let dt;const It=S.mipmaps,L=S.isVideoTexture!==!0,ht=vt.__version===void 0||j===!0,st=X.dataReady,rt=w(S,K);if(S.isDepthTexture)Rt=v(S.format===os,S.type),ht&&(L?e.texStorage2D(a.TEXTURE_2D,1,Rt,K.width,K.height):e.texImage2D(a.TEXTURE_2D,0,Rt,K.width,K.height,0,nt,Dt,null));else if(S.isDataTexture)if(It.length>0){L&&ht&&e.texStorage2D(a.TEXTURE_2D,rt,Rt,It[0].width,It[0].height);for(let J=0,Z=It.length;J<Z;J++)dt=It[J],L?st&&e.texSubImage2D(a.TEXTURE_2D,J,0,0,dt.width,dt.height,nt,Dt,dt.data):e.texImage2D(a.TEXTURE_2D,J,Rt,dt.width,dt.height,0,nt,Dt,dt.data);S.generateMipmaps=!1}else L?(ht&&e.texStorage2D(a.TEXTURE_2D,rt,Rt,K.width,K.height),st&&Wt(S,K,nt,Dt)):e.texImage2D(a.TEXTURE_2D,0,Rt,K.width,K.height,0,nt,Dt,K.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){L&&ht&&e.texStorage3D(a.TEXTURE_2D_ARRAY,rt,Rt,It[0].width,It[0].height,K.depth);for(let J=0,Z=It.length;J<Z;J++)if(dt=It[J],S.format!==ci)if(nt!==null)if(L){if(st)if(S.layerUpdates.size>0){const mt=Zo(dt.width,dt.height,S.format,S.type);for(const Ft of S.layerUpdates){const oe=dt.data.subarray(Ft*mt/dt.data.BYTES_PER_ELEMENT,(Ft+1)*mt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(a.TEXTURE_2D_ARRAY,J,0,0,Ft,dt.width,dt.height,1,nt,oe)}S.clearLayerUpdates()}else e.compressedTexSubImage3D(a.TEXTURE_2D_ARRAY,J,0,0,0,dt.width,dt.height,K.depth,nt,dt.data)}else e.compressedTexImage3D(a.TEXTURE_2D_ARRAY,J,Rt,dt.width,dt.height,K.depth,0,dt.data,0,0);else Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?st&&e.texSubImage3D(a.TEXTURE_2D_ARRAY,J,0,0,0,dt.width,dt.height,K.depth,nt,Dt,dt.data):e.texImage3D(a.TEXTURE_2D_ARRAY,J,Rt,dt.width,dt.height,K.depth,0,nt,Dt,dt.data)}else{L&&ht&&e.texStorage2D(a.TEXTURE_2D,rt,Rt,It[0].width,It[0].height);for(let J=0,Z=It.length;J<Z;J++)dt=It[J],S.format!==ci?nt!==null?L?st&&e.compressedTexSubImage2D(a.TEXTURE_2D,J,0,0,dt.width,dt.height,nt,dt.data):e.compressedTexImage2D(a.TEXTURE_2D,J,Rt,dt.width,dt.height,0,dt.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?st&&e.texSubImage2D(a.TEXTURE_2D,J,0,0,dt.width,dt.height,nt,Dt,dt.data):e.texImage2D(a.TEXTURE_2D,J,Rt,dt.width,dt.height,0,nt,Dt,dt.data)}else if(S.isDataArrayTexture)if(L){if(ht&&e.texStorage3D(a.TEXTURE_2D_ARRAY,rt,Rt,K.width,K.height,K.depth),st)if(S.layerUpdates.size>0){const J=Zo(K.width,K.height,S.format,S.type);for(const Z of S.layerUpdates){const mt=K.data.subarray(Z*J/K.data.BYTES_PER_ELEMENT,(Z+1)*J/K.data.BYTES_PER_ELEMENT);e.texSubImage3D(a.TEXTURE_2D_ARRAY,0,0,0,Z,K.width,K.height,1,nt,Dt,mt)}S.clearLayerUpdates()}else e.texSubImage3D(a.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,nt,Dt,K.data)}else e.texImage3D(a.TEXTURE_2D_ARRAY,0,Rt,K.width,K.height,K.depth,0,nt,Dt,K.data);else if(S.isData3DTexture)L?(ht&&e.texStorage3D(a.TEXTURE_3D,rt,Rt,K.width,K.height,K.depth),st&&e.texSubImage3D(a.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,nt,Dt,K.data)):e.texImage3D(a.TEXTURE_3D,0,Rt,K.width,K.height,K.depth,0,nt,Dt,K.data);else if(S.isFramebufferTexture){if(ht)if(L)e.texStorage2D(a.TEXTURE_2D,rt,Rt,K.width,K.height);else{let J=K.width,Z=K.height;for(let mt=0;mt<rt;mt++)e.texImage2D(a.TEXTURE_2D,mt,Rt,J,Z,0,nt,Dt,null),J>>=1,Z>>=1}}else if(It.length>0){if(L&&ht){const J=Nt(It[0]);e.texStorage2D(a.TEXTURE_2D,rt,Rt,J.width,J.height)}for(let J=0,Z=It.length;J<Z;J++)dt=It[J],L?st&&e.texSubImage2D(a.TEXTURE_2D,J,0,0,nt,Dt,dt):e.texImage2D(a.TEXTURE_2D,J,Rt,nt,Dt,dt);S.generateMipmaps=!1}else if(L){if(ht){const J=Nt(K);e.texStorage2D(a.TEXTURE_2D,rt,Rt,J.width,J.height)}st&&e.texSubImage2D(a.TEXTURE_2D,0,0,0,nt,Dt,K)}else e.texImage2D(a.TEXTURE_2D,0,Rt,nt,Dt,K);g(S)&&p($),vt.__version=X.version,S.onUpdate&&S.onUpdate(S)}D.__version=S.version}function Y(D,S,B){if(S.image.length!==6)return;const $=Gt(D,S),j=S.source;e.bindTexture(a.TEXTURE_CUBE_MAP,D.__webglTexture,a.TEXTURE0+B);const X=i.get(j);if(j.version!==X.__version||$===!0){e.activeTexture(a.TEXTURE0+B);const vt=jt.getPrimaries(jt.workingColorSpace),lt=S.colorSpace===Vi?null:jt.getPrimaries(S.colorSpace),Tt=S.colorSpace===Vi||vt===lt?a.NONE:a.BROWSER_DEFAULT_WEBGL;a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,S.flipY),a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),a.pixelStorei(a.UNPACK_ALIGNMENT,S.unpackAlignment),a.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL,Tt);const Mt=S.isCompressedTexture||S.image[0].isCompressedTexture,K=S.image[0]&&S.image[0].isDataTexture,nt=[];for(let Z=0;Z<6;Z++)!Mt&&!K?nt[Z]=x(S.image[Z],!0,n.maxCubemapSize):nt[Z]=K?S.image[Z].image:S.image[Z],nt[Z]=wt(S,nt[Z]);const Dt=nt[0],Rt=s.convert(S.format,S.colorSpace),dt=s.convert(S.type),It=_(S.internalFormat,Rt,dt,S.colorSpace),L=S.isVideoTexture!==!0,ht=X.__version===void 0||$===!0,st=j.dataReady;let rt=w(S,Dt);Vt(a.TEXTURE_CUBE_MAP,S);let J;if(Mt){L&&ht&&e.texStorage2D(a.TEXTURE_CUBE_MAP,rt,It,Dt.width,Dt.height);for(let Z=0;Z<6;Z++){J=nt[Z].mipmaps;for(let mt=0;mt<J.length;mt++){const Ft=J[mt];S.format!==ci?Rt!==null?L?st&&e.compressedTexSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,mt,0,0,Ft.width,Ft.height,Rt,Ft.data):e.compressedTexImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,mt,It,Ft.width,Ft.height,0,Ft.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?st&&e.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,mt,0,0,Ft.width,Ft.height,Rt,dt,Ft.data):e.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,mt,It,Ft.width,Ft.height,0,Rt,dt,Ft.data)}}}else{if(J=S.mipmaps,L&&ht){J.length>0&&rt++;const Z=Nt(nt[0]);e.texStorage2D(a.TEXTURE_CUBE_MAP,rt,It,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(K){L?st&&e.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,nt[Z].width,nt[Z].height,Rt,dt,nt[Z].data):e.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,It,nt[Z].width,nt[Z].height,0,Rt,dt,nt[Z].data);for(let mt=0;mt<J.length;mt++){const oe=J[mt].image[Z].image;L?st&&e.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,mt+1,0,0,oe.width,oe.height,Rt,dt,oe.data):e.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,mt+1,It,oe.width,oe.height,0,Rt,dt,oe.data)}}else{L?st&&e.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Rt,dt,nt[Z]):e.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,It,Rt,dt,nt[Z]);for(let mt=0;mt<J.length;mt++){const Ft=J[mt];L?st&&e.texSubImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,mt+1,0,0,Rt,dt,Ft.image[Z]):e.texImage2D(a.TEXTURE_CUBE_MAP_POSITIVE_X+Z,mt+1,It,Rt,dt,Ft.image[Z])}}}g(S)&&p(a.TEXTURE_CUBE_MAP),X.__version=j.version,S.onUpdate&&S.onUpdate(S)}D.__version=S.version}function pt(D,S,B,$,j,X){const vt=s.convert(B.format,B.colorSpace),lt=s.convert(B.type),Tt=_(B.internalFormat,vt,lt,B.colorSpace),Mt=i.get(S),K=i.get(B);if(K.__renderTarget=S,!Mt.__hasExternalTextures){const nt=Math.max(1,S.width>>X),Dt=Math.max(1,S.height>>X);j===a.TEXTURE_3D||j===a.TEXTURE_2D_ARRAY?e.texImage3D(j,X,Tt,nt,Dt,S.depth,0,vt,lt,null):e.texImage2D(j,X,Tt,nt,Dt,0,vt,lt,null)}e.bindFramebuffer(a.FRAMEBUFFER,D),xt(S)?o.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,$,j,K.__webglTexture,0,ae(S)):(j===a.TEXTURE_2D||j>=a.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=a.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&a.framebufferTexture2D(a.FRAMEBUFFER,$,j,K.__webglTexture,X),e.bindFramebuffer(a.FRAMEBUFFER,null)}function Ut(D,S,B){if(a.bindRenderbuffer(a.RENDERBUFFER,D),S.depthBuffer){const $=S.depthTexture,j=$&&$.isDepthTexture?$.type:null,X=v(S.stencilBuffer,j),vt=S.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,lt=ae(S);xt(S)?o.renderbufferStorageMultisampleEXT(a.RENDERBUFFER,lt,X,S.width,S.height):B?a.renderbufferStorageMultisample(a.RENDERBUFFER,lt,X,S.width,S.height):a.renderbufferStorage(a.RENDERBUFFER,X,S.width,S.height),a.framebufferRenderbuffer(a.FRAMEBUFFER,vt,a.RENDERBUFFER,D)}else{const $=S.textures;for(let j=0;j<$.length;j++){const X=$[j],vt=s.convert(X.format,X.colorSpace),lt=s.convert(X.type),Tt=_(X.internalFormat,vt,lt,X.colorSpace),Mt=ae(S);B&&xt(S)===!1?a.renderbufferStorageMultisample(a.RENDERBUFFER,Mt,Tt,S.width,S.height):xt(S)?o.renderbufferStorageMultisampleEXT(a.RENDERBUFFER,Mt,Tt,S.width,S.height):a.renderbufferStorage(a.RENDERBUFFER,Tt,S.width,S.height)}}a.bindRenderbuffer(a.RENDERBUFFER,null)}function _t(D,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(a.FRAMEBUFFER,D),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=i.get(S.depthTexture);$.__renderTarget=S,(!$.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),H(S.depthTexture,0);const j=$.__webglTexture,X=ae(S);if(S.depthTexture.format===as)xt(S)?o.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,a.DEPTH_ATTACHMENT,a.TEXTURE_2D,j,0,X):a.framebufferTexture2D(a.FRAMEBUFFER,a.DEPTH_ATTACHMENT,a.TEXTURE_2D,j,0);else if(S.depthTexture.format===os)xt(S)?o.framebufferTexture2DMultisampleEXT(a.FRAMEBUFFER,a.DEPTH_STENCIL_ATTACHMENT,a.TEXTURE_2D,j,0,X):a.framebufferTexture2D(a.FRAMEBUFFER,a.DEPTH_STENCIL_ATTACHMENT,a.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function Bt(D){const S=i.get(D),B=D.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==D.depthTexture){const $=D.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),$){const j=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,$.removeEventListener("dispose",j)};$.addEventListener("dispose",j),S.__depthDisposeCallback=j}S.__boundDepthTexture=$}if(D.depthTexture&&!S.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");const $=D.texture.mipmaps;$&&$.length>0?_t(S.__webglFramebuffer[0],D):_t(S.__webglFramebuffer,D)}else if(B){S.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(e.bindFramebuffer(a.FRAMEBUFFER,S.__webglFramebuffer[$]),S.__webglDepthbuffer[$]===void 0)S.__webglDepthbuffer[$]=a.createRenderbuffer(),Ut(S.__webglDepthbuffer[$],D,!1);else{const j=D.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,X=S.__webglDepthbuffer[$];a.bindRenderbuffer(a.RENDERBUFFER,X),a.framebufferRenderbuffer(a.FRAMEBUFFER,j,a.RENDERBUFFER,X)}}else{const $=D.texture.mipmaps;if($&&$.length>0?e.bindFramebuffer(a.FRAMEBUFFER,S.__webglFramebuffer[0]):e.bindFramebuffer(a.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=a.createRenderbuffer(),Ut(S.__webglDepthbuffer,D,!1);else{const j=D.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,X=S.__webglDepthbuffer;a.bindRenderbuffer(a.RENDERBUFFER,X),a.framebufferRenderbuffer(a.FRAMEBUFFER,j,a.RENDERBUFFER,X)}}e.bindFramebuffer(a.FRAMEBUFFER,null)}function Te(D,S,B){const $=i.get(D);S!==void 0&&pt($.__webglFramebuffer,D,D.texture,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,0),B!==void 0&&Bt(D)}function kt(D){const S=D.texture,B=i.get(D),$=i.get(S);D.addEventListener("dispose",A);const j=D.textures,X=D.isWebGLCubeRenderTarget===!0,vt=j.length>1;if(vt||($.__webglTexture===void 0&&($.__webglTexture=a.createTexture()),$.__version=S.version,r.memory.textures++),X){B.__webglFramebuffer=[];for(let lt=0;lt<6;lt++)if(S.mipmaps&&S.mipmaps.length>0){B.__webglFramebuffer[lt]=[];for(let Tt=0;Tt<S.mipmaps.length;Tt++)B.__webglFramebuffer[lt][Tt]=a.createFramebuffer()}else B.__webglFramebuffer[lt]=a.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){B.__webglFramebuffer=[];for(let lt=0;lt<S.mipmaps.length;lt++)B.__webglFramebuffer[lt]=a.createFramebuffer()}else B.__webglFramebuffer=a.createFramebuffer();if(vt)for(let lt=0,Tt=j.length;lt<Tt;lt++){const Mt=i.get(j[lt]);Mt.__webglTexture===void 0&&(Mt.__webglTexture=a.createTexture(),r.memory.textures++)}if(D.samples>0&&xt(D)===!1){B.__webglMultisampledFramebuffer=a.createFramebuffer(),B.__webglColorRenderbuffer=[],e.bindFramebuffer(a.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let lt=0;lt<j.length;lt++){const Tt=j[lt];B.__webglColorRenderbuffer[lt]=a.createRenderbuffer(),a.bindRenderbuffer(a.RENDERBUFFER,B.__webglColorRenderbuffer[lt]);const Mt=s.convert(Tt.format,Tt.colorSpace),K=s.convert(Tt.type),nt=_(Tt.internalFormat,Mt,K,Tt.colorSpace,D.isXRRenderTarget===!0),Dt=ae(D);a.renderbufferStorageMultisample(a.RENDERBUFFER,Dt,nt,D.width,D.height),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+lt,a.RENDERBUFFER,B.__webglColorRenderbuffer[lt])}a.bindRenderbuffer(a.RENDERBUFFER,null),D.depthBuffer&&(B.__webglDepthRenderbuffer=a.createRenderbuffer(),Ut(B.__webglDepthRenderbuffer,D,!0)),e.bindFramebuffer(a.FRAMEBUFFER,null)}}if(X){e.bindTexture(a.TEXTURE_CUBE_MAP,$.__webglTexture),Vt(a.TEXTURE_CUBE_MAP,S);for(let lt=0;lt<6;lt++)if(S.mipmaps&&S.mipmaps.length>0)for(let Tt=0;Tt<S.mipmaps.length;Tt++)pt(B.__webglFramebuffer[lt][Tt],D,S,a.COLOR_ATTACHMENT0,a.TEXTURE_CUBE_MAP_POSITIVE_X+lt,Tt);else pt(B.__webglFramebuffer[lt],D,S,a.COLOR_ATTACHMENT0,a.TEXTURE_CUBE_MAP_POSITIVE_X+lt,0);g(S)&&p(a.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(vt){for(let lt=0,Tt=j.length;lt<Tt;lt++){const Mt=j[lt],K=i.get(Mt);let nt=a.TEXTURE_2D;(D.isWebGL3DRenderTarget||D.isWebGLArrayRenderTarget)&&(nt=D.isWebGL3DRenderTarget?a.TEXTURE_3D:a.TEXTURE_2D_ARRAY),e.bindTexture(nt,K.__webglTexture),Vt(nt,Mt),pt(B.__webglFramebuffer,D,Mt,a.COLOR_ATTACHMENT0+lt,nt,0),g(Mt)&&p(nt)}e.unbindTexture()}else{let lt=a.TEXTURE_2D;if((D.isWebGL3DRenderTarget||D.isWebGLArrayRenderTarget)&&(lt=D.isWebGL3DRenderTarget?a.TEXTURE_3D:a.TEXTURE_2D_ARRAY),e.bindTexture(lt,$.__webglTexture),Vt(lt,S),S.mipmaps&&S.mipmaps.length>0)for(let Tt=0;Tt<S.mipmaps.length;Tt++)pt(B.__webglFramebuffer[Tt],D,S,a.COLOR_ATTACHMENT0,lt,Tt);else pt(B.__webglFramebuffer,D,S,a.COLOR_ATTACHMENT0,lt,0);g(S)&&p(lt),e.unbindTexture()}D.depthBuffer&&Bt(D)}function he(D){const S=D.textures;for(let B=0,$=S.length;B<$;B++){const j=S[B];if(g(j)){const X=b(D),vt=i.get(j).__webglTexture;e.bindTexture(X,vt),p(X),e.unbindTexture()}}}const I=[],Xt=[];function qt(D){if(D.samples>0){if(xt(D)===!1){const S=D.textures,B=D.width,$=D.height;let j=a.COLOR_BUFFER_BIT;const X=D.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT,vt=i.get(D),lt=S.length>1;if(lt)for(let Mt=0;Mt<S.length;Mt++)e.bindFramebuffer(a.FRAMEBUFFER,vt.__webglMultisampledFramebuffer),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+Mt,a.RENDERBUFFER,null),e.bindFramebuffer(a.FRAMEBUFFER,vt.__webglFramebuffer),a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0+Mt,a.TEXTURE_2D,null,0);e.bindFramebuffer(a.READ_FRAMEBUFFER,vt.__webglMultisampledFramebuffer);const Tt=D.texture.mipmaps;Tt&&Tt.length>0?e.bindFramebuffer(a.DRAW_FRAMEBUFFER,vt.__webglFramebuffer[0]):e.bindFramebuffer(a.DRAW_FRAMEBUFFER,vt.__webglFramebuffer);for(let Mt=0;Mt<S.length;Mt++){if(D.resolveDepthBuffer&&(D.depthBuffer&&(j|=a.DEPTH_BUFFER_BIT),D.stencilBuffer&&D.resolveStencilBuffer&&(j|=a.STENCIL_BUFFER_BIT)),lt){a.framebufferRenderbuffer(a.READ_FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.RENDERBUFFER,vt.__webglColorRenderbuffer[Mt]);const K=i.get(S[Mt]).__webglTexture;a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0,a.TEXTURE_2D,K,0)}a.blitFramebuffer(0,0,B,$,0,0,B,$,j,a.NEAREST),l===!0&&(I.length=0,Xt.length=0,I.push(a.COLOR_ATTACHMENT0+Mt),D.depthBuffer&&D.resolveDepthBuffer===!1&&(I.push(X),Xt.push(X),a.invalidateFramebuffer(a.DRAW_FRAMEBUFFER,Xt)),a.invalidateFramebuffer(a.READ_FRAMEBUFFER,I))}if(e.bindFramebuffer(a.READ_FRAMEBUFFER,null),e.bindFramebuffer(a.DRAW_FRAMEBUFFER,null),lt)for(let Mt=0;Mt<S.length;Mt++){e.bindFramebuffer(a.FRAMEBUFFER,vt.__webglMultisampledFramebuffer),a.framebufferRenderbuffer(a.FRAMEBUFFER,a.COLOR_ATTACHMENT0+Mt,a.RENDERBUFFER,vt.__webglColorRenderbuffer[Mt]);const K=i.get(S[Mt]).__webglTexture;e.bindFramebuffer(a.FRAMEBUFFER,vt.__webglFramebuffer),a.framebufferTexture2D(a.DRAW_FRAMEBUFFER,a.COLOR_ATTACHMENT0+Mt,a.TEXTURE_2D,K,0)}e.bindFramebuffer(a.DRAW_FRAMEBUFFER,vt.__webglMultisampledFramebuffer)}else if(D.depthBuffer&&D.resolveDepthBuffer===!1&&l){const S=D.stencilBuffer?a.DEPTH_STENCIL_ATTACHMENT:a.DEPTH_ATTACHMENT;a.invalidateFramebuffer(a.DRAW_FRAMEBUFFER,[S])}}}function ae(D){return Math.min(n.maxSamples,D.samples)}function xt(D){const S=i.get(D);return D.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function ce(D){const S=r.render.frame;c.get(D)!==S&&(c.set(D,S),D.update())}function wt(D,S){const B=D.colorSpace,$=D.format,j=D.type;return D.isCompressedTexture===!0||D.isVideoTexture===!0||B!==On&&B!==Vi&&(jt.getTransfer(B)===ie?($!==ci||j!==yi)&&Lt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):fe("WebGLTextures: Unsupported texture color space:",B)),S}function Nt(D){return typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement?(h.width=D.naturalWidth||D.width,h.height=D.naturalHeight||D.height):typeof VideoFrame<"u"&&D instanceof VideoFrame?(h.width=D.displayWidth,h.height=D.displayHeight):(h.width=D.width,h.height=D.height),h}this.allocateTextureUnit=F,this.resetTextureUnits=P,this.setTexture2D=H,this.setTexture2DArray=V,this.setTexture3D=Q,this.setTextureCube=W,this.rebindTextures=Te,this.setupRenderTarget=kt,this.updateRenderTargetMipmap=he,this.updateMultisampleRenderTarget=qt,this.setupDepthRenderbuffer=Bt,this.setupFrameBufferTexture=pt,this.useMultisampledRTT=xt}function vm(a,t){function e(i,n=Vi){let s;const r=jt.getTransfer(n);if(i===yi)return a.UNSIGNED_BYTE;if(i===Ha)return a.UNSIGNED_SHORT_4_4_4_4;if(i===Va)return a.UNSIGNED_SHORT_5_5_5_1;if(i===Rl)return a.UNSIGNED_INT_5_9_9_9_REV;if(i===Cl)return a.UNSIGNED_INT_10F_11F_11F_REV;if(i===El)return a.BYTE;if(i===Al)return a.SHORT;if(i===ss)return a.UNSIGNED_SHORT;if(i===ka)return a.INT;if(i===on)return a.UNSIGNED_INT;if(i===Mi)return a.FLOAT;if(i===Hn)return a.HALF_FLOAT;if(i===Dl)return a.ALPHA;if(i===Pl)return a.RGB;if(i===ci)return a.RGBA;if(i===as)return a.DEPTH_COMPONENT;if(i===os)return a.DEPTH_STENCIL;if(i===Wa)return a.RED;if(i===Xa)return a.RED_INTEGER;if(i===qa)return a.RG;if(i===$a)return a.RG_INTEGER;if(i===Za)return a.RGBA_INTEGER;if(i===Hs||i===Vs||i===Ws||i===Xs)if(r===ie)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Hs)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Vs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ws)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Xs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Hs)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Vs)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ws)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Xs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===ra||i===aa||i===oa||i===la)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===ra)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===aa)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===oa)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===la)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===ha||i===ca||i===da)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(i===ha||i===ca)return r===ie?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===da)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===ua||i===fa||i===pa||i===ma||i===ga||i===xa||i===_a||i===Ma||i===va||i===ya||i===ba||i===Sa||i===wa||i===Ta)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(i===ua)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===fa)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===pa)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ma)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===ga)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===xa)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===_a)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Ma)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===va)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===ya)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ba)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Sa)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===wa)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Ta)return r===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ea||i===Aa||i===Ra)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(i===Ea)return r===ie?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Aa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Ra)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Ca||i===Da||i===Pa||i===Ia)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(i===Ca)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Da)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Pa)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Ia)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===rs?a.UNSIGNED_INT_24_8:a[i]!==void 0?a[i]:null}return{convert:e}}const ym=`
void main() {
