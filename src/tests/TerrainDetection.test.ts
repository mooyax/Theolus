...
describe('Terrain Detection Logic', () => {
    ...
    beforeEach(() => {
        ...
        terrain.getRegion = (x: number, z: number) => {
    ...
    it('should detect target in same region', () => {
        ...
        const list = [target];
        const best = terrain.findBestTarget('goblin', cx, cz, 10, (e: any, dist: number) => dist, list);
    ...
    it('should NOT detect target in different region (Cross Mountain)', () => {
        ...
        const best = terrain.findBestTarget('goblin', cx, cz, 20, (e: any, dist: number) => dist, list);
    ...
    it('should rely on Grid search and respect regions', () => {
        ...
        const best = terrain.findBestTarget('goblin', cx, cz, 20, (e: any, dist: number) => dist, null);
